...
int main() {
    ...
    display_type(variadic_get<0>(nullptr, "const char", 35, "my string"s, 4.556));
    display_type(variadic_get<1>(nullptr, "const char", 35, "my string"s, 4.556));
    display_type(variadic_get<2>(nullptr, "const char", 35, "my string"s, 4.556));
    display_type(variadic_get<3>(nullptr, "const char", 35, "my string"s, 4.556));
    display_type(variadic_get<4>(nullptr, "const char", 35, "my string"s, 4.556));
